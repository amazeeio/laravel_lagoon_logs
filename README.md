...
In a vanilla Laravel installation, this is most easily done by setting the environment variable `LOG_CHANNEL` to `LagoonLogs`.
...
See [the Laravel docs](https://laravel.com/docs/logging) for more on customizing logging.
